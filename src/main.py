...
optimizers = {
    ...
    "2W-BGD": optim.SGD(net.parameters(), lr=lr_start),
    "MBT-MMT": optim.SGD(net.parameters(), lr=lr_start, momentum=momentum),
    "MBT-NAG": optim.SGD(
        ...
        for epoch in range(start_epoch, end_epoch):
            if patient < 50:
                ...
                json.dump(
                    all_history,
                    open(
                        "history/optimizers/optimizers_cifar%d.json" % (num_classes),
                        "w",
                    ),
                    indent=4,
                )
                pickle.dump(
                    all_history,
                    open(
                        "history/optimizers/optimizers_cifar%d.pickle" % (num_classes),
                        "wb",
                    ),
                )
